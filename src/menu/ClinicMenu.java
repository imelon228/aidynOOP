...
public class ClinicMenu implements Menu {
    ...
    private void addSurgery() {
        try {
            ...
            Surgery surgery = new Surgery(treatmentId, cost, completed, anesthesiaType, riskLevel);
    ...
    private void addVaccination() {
        try {
            ...
            Vaccination vaccination = new Vaccination(treatmentId, cost, completed, vaccineName, doseNumber);
    ...
    private void updateTreatment() {
        ...
        try {
            ...
            if (existingTreatment instanceof Vaccination) {
                ...
                Vaccination updatedVac = new Vaccination(treatmentId, newCost, newComplete, newVacName, newDosNum);
                ...
                Surgery updatedSur = new Surgery(treatmentId, newCost, newComplete, newAnes, newRisk);
    ...
    public void displayMenu() {
        ...
        System.out.println("│ 5. View Surgery                            │");
